...
/* ThinkPad color scheme */
static const char col_bg[]          = "#1a1a1a";  /* deep black */
static const char col_bg2[]         = "#2d2d2d";  /* dark gray (inactive border) */
static const char col_fg[]          = "#c0c0c0";  /* light gray text */
static const char col_fg2[]         = "#ffffff";  /* white (selected text) */
static const char col_red[]         = "#cc0000";  /* ThinkPad red */

static const char *colors[][3]      = {
	/*               fg        bg        border   */
	[SchemeNorm] = { col_fg,  col_bg,   col_bg2 },
	[SchemeSel]  = { col_fg2, col_red,  col_red  },
};
...
static const Rule rules[] = {
	...
	{ NULL,         NULL,       "DWM Cheatsheet", 1 << 8, 0,           -1 },
};
...
static const int refreshrate = 60;   /* refresh rate for client move/resize */
...
/* key definitions — use Super key (Mod4) on ThinkPad */
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont,
	"-nb", col_bg, "-nf", col_fg, "-sb", col_red, "-sf", col_fg2, NULL };
